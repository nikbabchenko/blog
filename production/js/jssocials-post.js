...
(function(window, $, jsSocials, undefined) {
    ...
    $.extend(jsSocials.shares, {
        twitter: {
            logo: "images/social-twiiter-small.png",
        ...
        googleplus: {
            logo: "images/social-google-small.png",
            ...
            getCount: function(data) {
              ...
              vk: {
            logo: "images/social-vk-small.png",
            shareUrl: "https://vk.com/share.php?url={url}",
            countUrl: "https://vkontakte.ru/share.php?act=count&index=1&url={url}",
            getCount: function(data) {
                return data.count;
            }
          }
